...
public class EnableAuthenticatorModel : PageModel
{
    ...
    public EnableAuthenticatorModel([NotNull] UserManager userManager, [NotNull] UrlEncoder urlEncoder, [NotNull] ILogger<EnableAuthenticatorModel> logger)
    {
    ...
    [NotNull]
    private string FormatKey([NotNull] string unformattedKey)
    {
    ...
    [NotNull]
    private string GenerateQrCodeUri([NotNull] string email, string unformattedKey)
    {
